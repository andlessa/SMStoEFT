...
GC_2 = Coupling(name = 'GC_2',
                value = '4*cdd*complex(0,1)',
                order = {'NPcdd':1,'QCD':4})

GC_3 = Coupling(name = 'GC_3',
                value = '6*cdd*complex(0,1)',
                order = {'NPcdd':1,'QCD':4})
...
GC_6 = Coupling(name = 'GC_6',
                value = '2*cqq1*complex(0,1)',
                order = {'NPcqq1':1,'QCD':4})

GC_7 = Coupling(name = 'GC_7',
                value = '-4*cqq1*complex(0,1)',
                order = {'NPcqq1':1,'QCD':4})

GC_8 = Coupling(name = 'GC_8',
                value = '6*cqq1*complex(0,1)',
                order = {'NPcqq1':1,'QCD':4})
...
GC_19 = Coupling(name = 'GC_19',
                 value = '4*cuua*complex(0,1)',
                 order = {'NPcuu':1,'QCD':4})

GC_20 = Coupling(name = 'GC_20',
                 value = '6*cuua*complex(0,1)',
                 order = {'NPcuu':1,'QCD':4})

GC_21 = Coupling(name = 'GC_21',
                 value = 'cuub*complex(0,1)',
                 order = {'NP':2,'NPcuu':1,'QCD':2})

GC_22 = Coupling(name = 'GC_22',
                 value = '-3*cuub*complex(0,1)',
                 order = {'NP':2,'NPcuu':1,'QCD':2})
