...
Decay_b = Decay(name = 'Decay_b',
                particle = P.b,
                partial_widths = {(P.W__minus__,P.t):'(((3*ee**2*MB**2)/(2.*sw**2) + (3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MB**4)/(2.*MW**2*sw**2) - (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2 + (3*cHq1*ee**2*MB**2*vev**2)/sw**2 + (3*cHq1*ee**2*MT**2*vev**2)/sw**2 + (3*cHq1*ee**2*MB**4*vev**2)/(MW**2*sw**2) - (6*cHq1*ee**2*MB**2*MT**2*vev**2)/(MW**2*sw**2) + (3*cHq1*ee**2*MT**4*vev**2)/(MW**2*sw**2) - (6*cHq1*ee**2*MW**2*vev**2)/sw**2 + (3*cHq1**2*ee**2*MB**2*vev**4)/(2.*sw**2) + (3*cHq1**2*ee**2*MT**2*vev**4)/(2.*sw**2) + (3*cHq1**2*ee**2*MB**4*vev**4)/(2.*MW**2*sw**2) - (3*cHq1**2*ee**2*MB**2*MT**2*vev**4)/(MW**2*sw**2) + (3*cHq1**2*ee**2*MT**4*vev**4)/(2.*MW**2*sw**2) - (3*cHq1**2*ee**2*MW**2*vev**4)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MB)**3)'})
...
Decay_H = Decay(name = 'Decay_H',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-12*MB**2*yb**2 + 3*MH**2*yb**2)*cmath.sqrt(-4*MB**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
                                  ...
                                  (P.t,P.t__tilde__):'(((27*cuH**2*MH**2*vev**4)/4. - 27*cuH**2*MT**2*vev**4 - 9*cuH*MH**2*vev**2*yt + 36*cuH*MT**2*vev**2*yt + 3*MH**2*yt**2 - 12*MT**2*yt**2)*cmath.sqrt(MH**4 - 4*MH**2*MT**2))/(16.*cmath.pi*abs(MH)**3)',
...
Decay_t = Decay(name = 'Decay_t',
                particle = P.t,
                partial_widths = {(P.W__plus__,P.b):'(((3*ee**2*MB**2)/(2.*sw**2) + (3*ee**2*MT**2)/(2.*sw**2) + (3*ee**2*MB**4)/(2.*MW**2*sw**2) - (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) + (3*ee**2*MT**4)/(2.*MW**2*sw**2) - (3*ee**2*MW**2)/sw**2 + (3*cHq1*ee**2*MB**2*vev**2)/sw**2 + (3*cHq1*ee**2*MT**2*vev**2)/sw**2 + (3*cHq1*ee**2*MB**4*vev**2)/(MW**2*sw**2) - (6*cHq1*ee**2*MB**2*MT**2*vev**2)/(MW**2*sw**2) + (3*cHq1*ee**2*MT**4*vev**2)/(MW**2*sw**2) - (6*cHq1*ee**2*MW**2*vev**2)/sw**2 + (3*cHq1**2*ee**2*MB**2*vev**4)/(2.*sw**2) + (3*cHq1**2*ee**2*MT**2*vev**4)/(2.*sw**2) + (3*cHq1**2*ee**2*MB**4*vev**4)/(2.*MW**2*sw**2) - (3*cHq1**2*ee**2*MB**2*MT**2*vev**4)/(MW**2*sw**2) + (3*cHq1**2*ee**2*MT**4*vev**4)/(2.*MW**2*sw**2) - (3*cHq1**2*ee**2*MW**2*vev**4)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(96.*cmath.pi*abs(MT)**3)'})
...
Decay_W__plus__ = Decay(name = 'Decay_W__plus__',
                        ...
                        partial_widths = {(P.c,P.s__tilde__):'(ee**2*MW**4)/(16.*cmath.pi*sw**2*abs(MW)**3)',
                                          (P.t,P.b__tilde__):'(((-3*ee**2*MB**2)/(2.*sw**2) - (3*ee**2*MT**2)/(2.*sw**2) - (3*ee**2*MB**4)/(2.*MW**2*sw**2) + (3*ee**2*MB**2*MT**2)/(MW**2*sw**2) - (3*ee**2*MT**4)/(2.*MW**2*sw**2) + (3*ee**2*MW**2)/sw**2 - (3*cHq1*ee**2*MB**2*vev**2)/sw**2 - (3*cHq1*ee**2*MT**2*vev**2)/sw**2 - (3*cHq1*ee**2*MB**4*vev**2)/(MW**2*sw**2) + (6*cHq1*ee**2*MB**2*MT**2*vev**2)/(MW**2*sw**2) - (3*cHq1*ee**2*MT**4*vev**2)/(MW**2*sw**2) + (6*cHq1*ee**2*MW**2*vev**2)/sw**2 - (3*cHq1**2*ee**2*MB**2*vev**4)/(2.*sw**2) - (3*cHq1**2*ee**2*MT**2*vev**4)/(2.*sw**2) - (3*cHq1**2*ee**2*MB**4*vev**4)/(2.*MW**2*sw**2) + (3*cHq1**2*ee**2*MB**2*MT**2*vev**4)/(MW**2*sw**2) - (3*cHq1**2*ee**2*MT**4*vev**4)/(2.*MW**2*sw**2) + (3*cHq1**2*ee**2*MW**2*vev**4)/sw**2)*cmath.sqrt(MB**4 - 2*MB**2*MT**2 + MT**4 - 2*MB**2*MW**2 - 2*MT**2*MW**2 + MW**4))/(48.*cmath.pi*abs(MW)**3)',
...
Decay_Z = Decay(name = 'Decay_Z',
                particle = P.Z,
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2) - 20*cHq1*ee**2*MB**2*vev**2 + 8*cHq1*ee**2*MZ**2*vev**2 - (6*cHq1*cw**2*ee**2*MB**2*vev**2)/sw**2 + (6*cHq1*cw**2*ee**2*MZ**2*vev**2)/sw**2 - (14*cHq1*ee**2*MB**2*sw**2*vev**2)/cw**2 + (2*cHq1*ee**2*MZ**2*sw**2*vev**2)/cw**2 - 12*cHq1**2*ee**2*MB**2*vev**4 + 12*cHq1**2*ee**2*MZ**2*vev**4 - (6*cHq1**2*cw**2*ee**2*MB**2*vev**4)/sw**2 + (6*cHq1**2*cw**2*ee**2*MZ**2*vev**4)/sw**2 - (6*cHq1**2*ee**2*MB**2*sw**2*vev**4)/cw**2 + (6*cHq1**2*ee**2*MZ**2*sw**2*vev**4)/cw**2)*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
