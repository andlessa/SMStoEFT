...
Decay_chi = Decay(name = 'Decay_chi',
                  particle = P.chi,
                  partial_widths = {(P.sig3__tilde__,P.t):'((-3*gtL**2*m3**2 - 3*gtR**2*m3**2 + 3*gtL**2*mchi**2 + 3*gtR**2*mchi**2 + 12*gtL*gtR*mchi*MT + 3*gtL**2*MT**2 + 3*gtR**2*MT**2)*cmath.sqrt(m3**4 - 2*m3**2*mchi**2 + mchi**4 - 2*m3**2*MT**2 - 2*mchi**2*MT**2 + MT**4))/(32.*cmath.pi*abs(mchi)**3)',
                                    (P.sig3,P.t__tilde__):'((-3*gtL**2*m3**2 - 3*gtR**2*m3**2 + 3*gtL**2*mchi**2 + 3*gtR**2*mchi**2 + 12*gtL*gtR*mchi*MT + 3*gtL**2*MT**2 + 3*gtR**2*MT**2)*cmath.sqrt(m3**4 - 2*m3**2*mchi**2 + mchi**4 - 2*m3**2*MT**2 - 2*mchi**2*MT**2 + MT**4))/(32.*cmath.pi*abs(mchi)**3)'})
...
Decay_sig3 = Decay(name = 'Decay_sig3',
                   particle = P.sig3,
                   partial_widths = {(P.t,P.chi):'((3*gtL**2*m3**2 + 3*gtR**2*m3**2 - 3*gtL**2*mchi**2 - 3*gtR**2*mchi**2 - 12*gtL*gtR*mchi*MT - 3*gtL**2*MT**2 - 3*gtR**2*MT**2)*cmath.sqrt(m3**4 - 2*m3**2*mchi**2 + mchi**4 - 2*m3**2*MT**2 - 2*mchi**2*MT**2 + MT**4))/(48.*cmath.pi*abs(m3)**3)'})

Decay_t = Decay(name = 'Decay_t',
                particle = P.t,
                partial_widths = {(P.sig3,P.chi):'((-3*gtL**2*m3**2 - 3*gtR**2*m3**2 + 3*gtL**2*mchi**2 + 3*gtR**2*mchi**2 + 12*gtL*gtR*mchi*MT + 3*gtL**2*MT**2 + 3*gtR**2*MT**2)*cmath.sqrt(m3**4 - 2*m3**2*mchi**2 + mchi**4 - 2*m3**2*MT**2 - 2*mchi**2*MT**2 + MT**4))/(96.*cmath.pi*abs(MT)**3)',
