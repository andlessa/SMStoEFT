...
R2GC_108_12 = Coupling(name = 'R2GC_108_12',
                       value = '(complex(0,1)*G**2*MT)/(6*cmath.pi**2)',
                       order = {'QCD':2})

R2GC_109_13 = Coupling(name = 'R2GC_109_13',
...
R2GC_111_15 = Coupling(name = 'R2GC_111_15',
                       value = '(ee*complex(0,1)*G**2*sw)/(9*cw*cmath.pi**2)',
                       order = {'QCD':2,'QED':1})

R2GC_112_16 = Coupling(name = 'R2GC_112_16',
                       value = '(complex(0,1)*G**2*yt)/(3*cmath.pi**2*cmath.sqrt(2))',
                       order = {'QCD':2,'QED':1})

R2GC_30_17 = Coupling(name = 'R2GC_30_17',
                      value = '(-(complex(0,1)*G**2))/(16*cmath.pi**2)',
                      order = {'QCD':2})

R2GC_31_18 = Coupling(name = 'R2GC_31_18',
                      value = '(-(complex(0,1)*G**2*MB**2))/(8*cmath.pi**2)',
                      order = {'QCD':2})

R2GC_31_19 = Coupling(name = 'R2GC_31_19',
...
R2GC_41_38 = Coupling(name = 'R2GC_41_38',
...
R2GC_42_39 = Coupling(name = 'R2GC_42_39',
                      value = '(ee**2*complex(0,1)*G**2)/(96*cmath.pi**2*sw**2)',
                      order = {'QCD':2,'QED':2})

R2GC_45_40 = Coupling(name = 'R2GC_45_40',
                      value = '(-G**4)/(192*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_45_41 = Coupling(name = 'R2GC_45_41',
                      value = '(G**4)/(64*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_46_42 = Coupling(name = 'R2GC_46_42',
                      value = '(complex(0,1)*G**4)/(64*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_47_43 = Coupling(name = 'R2GC_47_43',
                      value = '(complex(0,1)*G**4)/(192*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_48_44 = Coupling(name = 'R2GC_48_44',
                      value = '(-(complex(0,1)*G**4))/(48*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_49_45 = Coupling(name = 'R2GC_49_45',
                      value = '(complex(0,1)*G**4)/(288*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_49_46 = Coupling(name = 'R2GC_49_46',
                      value = '(-(complex(0,1)*G**4))/(32*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_50_47 = Coupling(name = 'R2GC_50_47',
                      value = '(complex(0,1)*G**4)/(4*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_51_48 = Coupling(name = 'R2GC_51_48',
                      value = '(-23*complex(0,1)*G**4)/(64*cmath.pi**2)',
                      order = {'QCD':4})

R2GC_52_49 = Coupling(name = 'R2GC_52_49',
                      value = '(ee*complex(0,1)*G**2)/(18*cmath.pi**2)',
                      order = {'QCD':2,'QED':1})

R2GC_53_50 = Coupling(name = 'R2GC_53_50',
                      value = '(-(complex(0,1)*G**3))/(6*cmath.pi**2)',
                      order = {'QCD':3})

R2GC_55_51 = Coupling(name = 'R2GC_55_51',
                      value = '(-(ee*complex(0,1)*G**2))/(9*cmath.pi**2)',
                      order = {'QCD':2,'QED':1})

R2GC_68_52 = Coupling(name = 'R2GC_68_52',
                      value = '(cw*ee*complex(0,1)*G**2)/(12*cmath.pi**2*sw)+(ee*complex(0,1)*G**2*sw)/(36*cw*cmath.pi**2)',
                      order = {'QCD':2,'QED':1})

R2GC_69_53 = Coupling(name = 'R2GC_69_53',
                      value = '(-(ee*complex(0,1)*G**2*sw))/(18*cw*cmath.pi**2)',
                      order = {'QCD':2,'QED':1})

R2GC_93_54 = Coupling(name = 'R2GC_93_54',
...
R2GC_98_56 = Coupling(name = 'R2GC_98_56',
                      value = '(G**3)/(24*cmath.pi**2)',
                      order = {'QCD':3})

R2GC_98_57 = Coupling(name = 'R2GC_98_57',
                      value = '(11*G**3)/(64*cmath.pi**2)',
                      order = {'QCD':3})

R2GC_99_58 = Coupling(name = 'R2GC_99_58',
...
UVGC_44_36 = Coupling(name = 'UVGC_44_36',
                      value = {-1:'(-(complex(0,1)*G**2))/(32*cmath.pi**2)'},
                      order = {'QCD':2})

UVGC_45_37 = Coupling(name = 'UVGC_45_37',
                      value = {-1:'(3*G**4)/(512*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_45_38 = Coupling(name = 'UVGC_45_38',
                      value = {-1:'(-3*G**4)/(512*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_46_39 = Coupling(name = 'UVGC_46_39',
                      value = {-1:'(3*complex(0,1)*G**4)/(512*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_46_40 = Coupling(name = 'UVGC_46_40',
                      value = {-1:'(-3*complex(0,1)*G**4)/(512*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_48_41 = Coupling(name = 'UVGC_48_41',
                      value = {-1:'(-(complex(0,1)*G**4))/(128*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_48_42 = Coupling(name = 'UVGC_48_42',
                      value = {-1:'(complex(0,1)*G**4)/(128*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_49_43 = Coupling(name = 'UVGC_49_43',
                      value = {-1:'(-3*complex(0,1)*G**4)/(256*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_49_44 = Coupling(name = 'UVGC_49_44',
                      value = {-1:'(3*complex(0,1)*G**4)/(256*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_50_45 = Coupling(name = 'UVGC_50_45',
                      value = {-1:'(-(complex(0,1)*G**4))/(24*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_50_46 = Coupling(name = 'UVGC_50_46',
                      value = {-1:'(47*complex(0,1)*G**4)/(128*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_51_47 = Coupling(name = 'UVGC_51_47',
                      value = {-1:'(-253*complex(0,1)*G**4)/(512*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_51_48 = Coupling(name = 'UVGC_51_48',
                      value = {-1:'(5*complex(0,1)*G**4)/(512*cmath.pi**2)'},
                      order = {'QCD':4})

UVGC_52_49 = Coupling(name = 'UVGC_52_49',
                      value = {-1:'(ee*complex(0,1)*G**2)/(36*cmath.pi**2)'},
                      order = {'QCD':2,'QED':1})

UVGC_53_50 = Coupling(name = 'UVGC_53_50',
                      value = {-1:'(-13*complex(0,1)*G**3)/(48*cmath.pi**2)'},
                      order = {'QCD':3})

UVGC_54_51 = Coupling(name = 'UVGC_54_51',
                      value = {-1:'(complex(0,1)*G**2)/(12*cmath.pi**2)'},
                      order = {'QCD':2})

UVGC_55_52 = Coupling(name = 'UVGC_55_52',
