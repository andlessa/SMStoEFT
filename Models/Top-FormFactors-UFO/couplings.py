...
GC_64 = Coupling(name = 'GC_64',
                 value = '(4*C00eff*ee*cmath.pi**2*complex(0,1)*yDM**2)/3.',
                 order = {'NP':2,'QED':1})
...
GC_71 = Coupling(name = 'GC_71',
                 value = '(-4*C00eff*ee*cmath.pi**2*complex(0,1)*sw*yDM**2)/(3.*cw)',
                 order = {'NP':2,'QED':1})
...
GC_75 = Coupling(name = 'GC_75',
                 value = 'deltaCTR*complex(0,1) + 2*C00eff*cmath.pi**2*complex(0,1)*G*yDM**2',
                 order = {'NP':2,'QCD':1})
