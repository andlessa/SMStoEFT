...
Decay_Z = Decay(name = 'Decay_Z',
                ...
                partial_widths = {(P.b,P.b__tilde__):'((-7*ee**2*MB**2 + ee**2*MZ**2 - (3*cw**2*ee**2*MB**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) - (17*ee**2*MB**2*sw**2)/(6.*cw**2) + (5*ee**2*MZ**2*sw**2)/(6.*cw**2))*cmath.sqrt(-4*MB**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
                                  ...
                                  (P.t,P.t__tilde__):'((-11*ee**2*MT**2 - ee**2*MZ**2 - (3*cw**2*ee**2*MT**2)/(2.*sw**2) + (3*cw**2*ee**2*MZ**2)/(2.*sw**2) + (7*ee**2*MT**2*sw**2)/(6.*cw**2) + (17*ee**2*MZ**2*sw**2)/(6.*cw**2) - 24*C00eff*ee**2*cmath.pi**2*MT**2*yDM**2 - 40*C1*ee**2*cmath.pi**2*MT**4*yDM**2 - 40*C11*ee**2*cmath.pi**2*MT**4*yDM**2 - 40*C12*ee**2*cmath.pi**2*MT**4*yDM**2 - 20*C1*ee**2*cmath.pi**2*MT**2*MZ**2*yDM**2 - 20*C11*ee**2*cmath.pi**2*MT**2*MZ**2*yDM**2 - 20*C12*ee**2*cmath.pi**2*MT**2*MZ**2*yDM**2 - (8*C00eff*ee**2*cmath.pi**2*MT**2*sw**2*yDM**2)/(3.*cw**2) + (24*C1*ee**2*cmath.pi**2*MT**4*sw**2*yDM**2)/cw**2 + (24*C11*ee**2*cmath.pi**2*MT**4*sw**2*yDM**2)/cw**2 + (24*C12*ee**2*cmath.pi**2*MT**4*sw**2*yDM**2)/cw**2 + (32*C00eff*ee**2*cmath.pi**2*MZ**2*sw**2*yDM**2)/(3.*cw**2) + (4*C1*ee**2*cmath.pi**2*MT**2*MZ**2*sw**2*yDM**2)/(3.*cw**2) + (4*C11*ee**2*cmath.pi**2*MT**2*MZ**2*sw**2*yDM**2)/(3.*cw**2) + (4*C12*ee**2*cmath.pi**2*MT**2*MZ**2*sw**2*yDM**2)/(3.*cw**2) + (32*C1*ee**2*cmath.pi**2*MZ**4*sw**2*yDM**2)/(3.*cw**2) + (32*C11*ee**2*cmath.pi**2*MZ**4*sw**2*yDM**2)/(3.*cw**2) + (32*C12*ee**2*cmath.pi**2*MZ**4*sw**2*yDM**2)/(3.*cw**2) - (32*C00eff**2*ee**2*cmath.pi**4*MT**2*sw**2*yDM**4)/(3.*cw**2) + (64*C00eff*C1*ee**2*cmath.pi**4*MT**4*sw**2*yDM**4)/(3.*cw**2) + (64*C00eff*C11*ee**2*cmath.pi**4*MT**4*sw**2*yDM**4)/(3.*cw**2) + (64*C00eff*C12*ee**2*cmath.pi**4*MT**4*sw**2*yDM**4)/(3.*cw**2) + (224*C1**2*ee**2*cmath.pi**4*MT**6*sw**2*yDM**4)/(3.*cw**2) + (448*C1*C11*ee**2*cmath.pi**4*MT**6*sw**2*yDM**4)/(3.*cw**2) + (224*C11**2*ee**2*cmath.pi**4*MT**6*sw**2*yDM**4)/(3.*cw**2) + (448*C1*C12*ee**2*cmath.pi**4*MT**6*sw**2*yDM**4)/(3.*cw**2) + (448*C11*C12*ee**2*cmath.pi**4*MT**6*sw**2*yDM**4)/(3.*cw**2) + (224*C12**2*ee**2*cmath.pi**4*MT**6*sw**2*yDM**4)/(3.*cw**2) + (32*C00eff**2*ee**2*cmath.pi**4*MZ**2*sw**2*yDM**4)/(3.*cw**2) - (32*C00eff*C1*ee**2*cmath.pi**4*MT**2*MZ**2*sw**2*yDM**4)/(3.*cw**2) - (32*C00eff*C11*ee**2*cmath.pi**4*MT**2*MZ**2*sw**2*yDM**4)/(3.*cw**2) - (32*C00eff*C12*ee**2*cmath.pi**4*MT**2*MZ**2*sw**2*yDM**4)/(3.*cw**2) + (64*C00eff*C1*ee**2*cmath.pi**4*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (64*C00eff*C11*ee**2*cmath.pi**4*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (64*C00eff*C12*ee**2*cmath.pi**4*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (8*C1**2*ee**2*cmath.pi**4*MT**2*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (16*C1*C11*ee**2*cmath.pi**4*MT**2*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (8*C11**2*ee**2*cmath.pi**4*MT**2*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (16*C1*C12*ee**2*cmath.pi**4*MT**2*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (16*C11*C12*ee**2*cmath.pi**4*MT**2*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (8*C12**2*ee**2*cmath.pi**4*MT**2*MZ**4*sw**2*yDM**4)/(3.*cw**2) + (32*C1**2*ee**2*cmath.pi**4*MZ**6*sw**2*yDM**4)/(3.*cw**2) + (64*C1*C11*ee**2*cmath.pi**4*MZ**6*sw**2*yDM**4)/(3.*cw**2) + (32*C11**2*ee**2*cmath.pi**4*MZ**6*sw**2*yDM**4)/(3.*cw**2) + (64*C1*C12*ee**2*cmath.pi**4*MZ**6*sw**2*yDM**4)/(3.*cw**2) + (64*C11*C12*ee**2*cmath.pi**4*MZ**6*sw**2*yDM**4)/(3.*cw**2) + (32*C12**2*ee**2*cmath.pi**4*MZ**6*sw**2*yDM**4)/(3.*cw**2))*cmath.sqrt(-4*MT**2*MZ**2 + MZ**4))/(48.*cmath.pi*abs(MZ)**3)',
