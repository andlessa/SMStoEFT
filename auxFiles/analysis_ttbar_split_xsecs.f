...
c LO:     QCD^2 = 4 -> orders_tag_plot = 400
c NLOQCD: QCD^2 = 6 -> orders_tag_plot = 600
c NLONP2: QCD^2 = 4, NP^2 = 2 -> orders_tag_plot = 402
c NLONP4: QCD^2 = 4, NP^2 = 4 -> orders_tag_plot = 404

c SM_NLO-UFO model: (QCD+QED*100)
c LO:     QCD^2 = 4 -> orders_tag_plot = 4
c NLOQCD: QCD^2 = 6 -> orders_tag_plot = 6
...
c orders_tag_plot < 100 -> SM_NLO, otherwise SMS-stop_NLO
         if (orders_tag_plot.lt.100) then
             if (i.eq.1.and.orders_tag_plot.ne.4) cycle
             if (i.eq.2.and.orders_tag_plot.ne.6) cycle
             if (i.eq.3) cycle
             if (i.eq.4) cycle
         else
             if (i.eq.1.and.orders_tag_plot.ne.400) cycle
             if (i.eq.2.and.orders_tag_plot.ne.600) cycle
             if (i.eq.3.and.orders_tag_plot.ne.402) cycle
             if (i.eq.4.and.orders_tag_plot.ne.404) cycle
         endif
