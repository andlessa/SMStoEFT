...
c always fill the total rate
       do i=1,1
        l=(i-1)*104
c        if (mod(i,6).eq.1.and.orders_tag_plot.ne.400) cycle 
c        if (mod(i,6).eq.2.and.orders_tag_plot.ne.202.and.orders_tag_plot.ne.402) cycle 
c        if (mod(i,6).eq.3.and.orders_tag_plot.ne.4.and.orders_tag_plot.ne.404.and.orders_tag_plot.ne.204) cycle 
c        if (mod(i,6).eq.4.and.(.not.(orders_tag_plot.eq.600.or.
c     . orders_tag_plot.eq.400))) cycle 
c        if (mod(i,6).eq.5.and.(.not.(orders_tag_plot.eq.402.or.
c     .  orders_tag_plot.eq.202.or.orders_tag_plot.eq.602))) cycle
c        if (mod(i,6).eq.0.and.(.not.(orders_tag_plot.eq.204.or.
c     .  orders_tag_plot.eq.4.or.orders_tag_plot.eq.404.or.orders_tag_plot.eq.604))) cycle
